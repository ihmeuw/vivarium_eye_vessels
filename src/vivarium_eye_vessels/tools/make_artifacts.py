...
from vivarium_eye_vessels.constants import data_keys, metadata
from vivarium_eye_vessels.tools.app_logging import add_logging_sink, decode_status
from vivarium_eye_vessels.utilities import sanitize_location
...
def build_single_location_artifact(
    ...
    from vivarium_eye_vessels.data import builder
